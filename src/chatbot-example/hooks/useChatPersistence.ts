  ...
  messages: [
    {
      role: 'assistant',
      content:
        'Welcome to El Molino Tortilleria & Restaurant! I\'m here to answer any questions — from our menu to hours or anything else you\'d like to know. How can I assist you today?'
    }
  ],
  conversationId: null,
  isOpen: false,
